                ...
                <CommandGroup>
                  <div className="flex items-center justify-between">
                    {selectedValues.length > 0 && (
                      <>
                        <CommandItem
                          ...
                          className="flex-1 justify-center border bg-muted cursor-pointer hover:bg-muted/50"
                        >
                          Clear
                        </CommandItem>
                        <Separator
                    ...
                    <CommandItem
                      ...
                      className="flex-1 justify-center border bg-muted cursor-pointer max-w-full hover:bg-muted/50"
                    >
                      Close
                    </CommandItem>
                  </div>
